...
kable(head(iris), format = "pandoc")
kable(head(iris), format = "html")
kable(head(iris), format = "pandoc", caption = "Title of the table") 

kable(head(iris), format = "html", caption = "Title of the table")
# use the booktabs package
kable(mtcars, format = "pandoc", booktabs = TRUE)
# use the longtable package
kable(matrix(1000, ncol = 5), format = "pandoc", digits = 2, longtable = TRUE)
# change LaTeX default table environment
kable(head(iris), format = "pandoc", caption = "My table", table.envir = "table*")
